"""Tests for the AI categoriser â€” prompt building and JSON parsing."""
...
class TestBuildUserPrompt:
    ...
    def test_includes_existing_categories(self) -> None:
        prompt = _build_user_prompt(
            ...
            existing_categories=["Bar & CaffÃ¨", "Supermercato"],
        )
        assert '"Bar & CaffÃ¨"' in prompt
    ...
    def test_includes_counterpart_when_available(self) -> None:
        ...
        assert 'đối tác: "Andre Silva"' in prompt
