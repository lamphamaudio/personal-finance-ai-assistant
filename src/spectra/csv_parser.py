...
_DESCRIPTION_ALIASES = {
    ...
    "nội dung", "noi dung", "mô tả", "mo ta", "diễn giải", "dien giai",
    "nội dung giao dịch", "noi dung giao dich", "chi tiết", "chi tiet",
}
...
_COUNTERPART_ALIASES = {
    ...
    "đối tác", "doi tac", "tên đối tác", "ten doi tac",
...
_AMOUNT_ALIASES = {
    ...
    "net amount",
    "số tiền", "so tien", "giá trị", "gia tri", "phát sinh", "phat sinh",
}
_CREDIT_ALIASES = {
    "accredito", "credit", "entrate", "income", "in", "avere",
    "entrata", "versamento",
    "ghi có", "ghi co", "có", "co", "tiền vào", "tien vao",
    "số tiền ghi có", "so tien ghi co", "phát sinh có", "phat sinh co",
}
_DEBIT_ALIASES = {
    "addebito", "debit", "uscite", "expense", "out", "dare",
    "uscita", "prelievo", "pagamento",
    "ghi nợ", "ghi no", "nợ", "no", "tiền ra", "tien ra",
    "số tiền ghi nợ", "so tien ghi no", "phát sinh nợ", "phat sinh no",
}
...
_CURRENCY_ALIASES = {
    ...
    "loại tiền", "loai tien", "tiền tệ", "tien te", "đơn vị tiền", "don vi tien",
}
